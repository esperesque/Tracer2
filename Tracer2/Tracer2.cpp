...
int main()
{
	...
	Rectangle a_mirror(Point3D(20, -16, -3), Point3D(20, 16, -3), Point3D(20, -16, 10), Point3D(20, 16, 10), MIRROR, WHITE);
	...
	std::vector<Shape*> scene2_objects = { &floor_rect, &aSphere, &a_mirror };
	Scene scene2;
